...
import static com.soffid.org.objectweb.asm.Opcodes.DUP2_X1;
import static com.soffid.org.objectweb.asm.Opcodes.DUP2_X2;
import static com.soffid.org.objectweb.asm.Opcodes.DUP_X1;
import static com.soffid.org.objectweb.asm.Opcodes.DUP_X2;
...
import static com.soffid.org.objectweb.asm.Opcodes.NEWARRAY;
import static com.soffid.org.objectweb.asm.Opcodes.POP;
import static com.soffid.org.objectweb.asm.Opcodes.POP2;
import static com.soffid.org.objectweb.asm.Opcodes.SWAP;
import static com.soffid.org.objectweb.asm.Opcodes.T_DOUBLE;
import static com.soffid.org.objectweb.asm.Opcodes.T_INT;
import static com.soffid.org.objectweb.asm.Opcodes.T_LONG;
...
public abstract class Type implements Comparable<Type>, BytecodeOps, Serializable {
     ...
     */
    private static final Map<Class<?>, com.soffid.org.objectweb.asm.Type> INTERNAL_TYPE_CACHE =
            Collections.synchronizedMap(new WeakHashMap<Class<?>, com.soffid.org.objectweb.asm.Type>());

    /** Internal ASM type for this Type - computed once at construction */
    private transient final com.soffid.org.objectweb.asm.Type internalType;
    ...
    Type(final String name, final Class<?> clazz, final int weight, final int slots) {
        this.name         = name;
        this.clazz        = clazz;
        this.descriptor   = com.soffid.org.objectweb.asm.Type.getDescriptor(clazz);
        this.weight       = weight;
    ...
    public static String getMethodDescriptor(final Type returnType, final Type... types) {
        final com.soffid.org.objectweb.asm.Type[] itypes = new com.soffid.org.objectweb.asm.Type[types.length];
        for (int i = 0; i < types.length; i++) {
            itypes[i] = types[i].getInternalType();
        }
        return com.soffid.org.objectweb.asm.Type.getMethodDescriptor(returnType.getInternalType(), itypes);
    }
    ...
    public static String getMethodDescriptor(final Class<?> returnType, final Class<?>... types) {
        ...
        return com.soffid.org.objectweb.asm.Type.getMethodDescriptor(getInternalType(returnType), itypes);
    }
    ...
    private static Type typeFor(final com.soffid.org.objectweb.asm.Type itype) {
        switch (itype.getSort()) {
        case com.soffid.org.objectweb.asm.Type.BOOLEAN:
            return BOOLEAN;
        case com.soffid.org.objectweb.asm.Type.INT:
            return INT;
        case com.soffid.org.objectweb.asm.Type.LONG:
            return LONG;
        case com.soffid.org.objectweb.asm.Type.DOUBLE:
            return NUMBER;
        case com.soffid.org.objectweb.asm.Type.OBJECT:
        ...
        case com.soffid.org.objectweb.asm.Type.VOID:
            return null;
        case com.soffid.org.objectweb.asm.Type.ARRAY:
    ...
    public static Type getMethodReturnType(final String methodDescriptor) {
        return Type.typeFor(com.soffid.org.objectweb.asm.Type.getReturnType(methodDescriptor));
    }
    ...
    public static Type[] getMethodArguments(final String methodDescriptor) {
        final com.soffid.org.objectweb.asm.Type itypes[] = com.soffid.org.objectweb.asm.Type.getArgumentTypes(methodDescriptor);
    ...
    static com.soffid.org.objectweb.asm.Type getInternalType(final String className) {
        return com.soffid.org.objectweb.asm.Type.getType(className);
    }

    private com.soffid.org.objectweb.asm.Type getInternalType() {
        return internalType;
    }

    private static com.soffid.org.objectweb.asm.Type lookupInternalType(final Class<?> type) {
        final Map<Class<?>, com.soffid.org.objectweb.asm.Type> c = INTERNAL_TYPE_CACHE;
        com.soffid.org.objectweb.asm.Type itype = c.get(type);
        if (itype != null) {
            return itype;
        }
        itype = com.soffid.org.objectweb.asm.Type.getType(type);
        c.put(type, itype);
        return itype;
    }

    private static com.soffid.org.objectweb.asm.Type getInternalType(final Class<?> type) {
    ...
    public String getInternalName() {
        return com.soffid.org.objectweb.asm.Type.getInternalName(getTypeClass());
    }
    ...
    public static String getInternalName(final Class<?> clazz) {
        return com.soffid.org.objectweb.asm.Type.getInternalName(clazz);
    }
