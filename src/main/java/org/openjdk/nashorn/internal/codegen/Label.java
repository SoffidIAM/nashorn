...
public final class Label implements Serializable {
    ...
    private transient com.soffid.org.objectweb.asm.Label label;
    ...
    com.soffid.org.objectweb.asm.Label getLabel() {
        if (this.label == null) {
            this.label = new com.soffid.org.objectweb.asm.Label();
        }
        return label;
    }
