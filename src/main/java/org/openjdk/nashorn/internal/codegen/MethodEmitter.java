...
import static com.soffid.org.objectweb.asm.Opcodes.ATHROW;
...
import static com.soffid.org.objectweb.asm.Opcodes.GOTO;
import static com.soffid.org.objectweb.asm.Opcodes.H_INVOKEINTERFACE;
import static com.soffid.org.objectweb.asm.Opcodes.H_INVOKESTATIC;
import static com.soffid.org.objectweb.asm.Opcodes.IFEQ;
import static com.soffid.org.objectweb.asm.Opcodes.IFGE;
import static com.soffid.org.objectweb.asm.Opcodes.IFGT;
import static com.soffid.org.objectweb.asm.Opcodes.IFLE;
import static com.soffid.org.objectweb.asm.Opcodes.IFLT;
import static com.soffid.org.objectweb.asm.Opcodes.IFNE;
import static com.soffid.org.objectweb.asm.Opcodes.IFNONNULL;
import static com.soffid.org.objectweb.asm.Opcodes.IFNULL;
import static com.soffid.org.objectweb.asm.Opcodes.IF_ACMPEQ;
import static com.soffid.org.objectweb.asm.Opcodes.IF_ACMPNE;
import static com.soffid.org.objectweb.asm.Opcodes.IF_ICMPEQ;
import static com.soffid.org.objectweb.asm.Opcodes.IF_ICMPGE;
import static com.soffid.org.objectweb.asm.Opcodes.IF_ICMPGT;
import static com.soffid.org.objectweb.asm.Opcodes.IF_ICMPLE;
import static com.soffid.org.objectweb.asm.Opcodes.IF_ICMPLT;
import static com.soffid.org.objectweb.asm.Opcodes.IF_ICMPNE;
import static com.soffid.org.objectweb.asm.Opcodes.INSTANCEOF;
...
public class MethodEmitter {
    ...
    MethodEmitter loadType(final String className) {
        ...
        method.visitLdcInsn(com.soffid.org.objectweb.asm.Type.getObjectType(className));
    ...
    private static class LocalVariableDef {
        ...
        private final com.soffid.org.objectweb.asm.Label label;
        // The currently live type of the local variable.
        private final Type type;

        LocalVariableDef(final com.soffid.org.objectweb.asm.Label label, final Type type) {
            this.label = label;
            this.type = type;
        }
    ...
    private void endLocalValueDef(final Symbol symbol, final LocalVariableDef def, final com.soffid.org.objectweb.asm.Label label) {
    ...
    void store(final Symbol symbol, final Type type, final boolean onlySymbolLiveValue) {
        ...
        if (symbol.hasSlot()) {
            ...
            if(existingDef == null || existingDef.type != type) {
                final com.soffid.org.objectweb.asm.Label here = new com.soffid.org.objectweb.asm.Label();
                if(isLiveType) {
    ...
    static com.soffid.org.objectweb.asm.Label[] getLabels(final Label... table) {
        final com.soffid.org.objectweb.asm.Label[] internalLabels = new com.soffid.org.objectweb.asm.Label[table.length];
    ...
    void lineNumber(final int line) {
        if (context.getEnv()._debug_lines) {
            ...
            final com.soffid.org.objectweb.asm.Label l = new com.soffid.org.objectweb.asm.Label();
            method.visitLabel(l);
